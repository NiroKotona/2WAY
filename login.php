			...
			<div class="inform">
				<fieldset>
					<div class="infldset">
						...
						<div class="mui-textfield mui-textfield--float-label"><input type="text" name="req_username" value="<?php if (isset($_POST['req_username'])) echo pun_htmlspecialchars($_POST['req_username']); ?>" size="25" maxlength="25" tabindex="1" /><label><?php echo $lang_common['Username'] ?></label></div>
						<div class="mui-textfield mui-textfield--float-label"><input type="password" name="req_password" size="25" tabindex="2" /><label><?php echo $lang_common['Password'] ?></label></div>

						<div class="checkbox rbox">
							<label><input type="checkbox" checked="checked" name="save_pass" value="1"<?php if (isset($_POST['save_pass'])) echo ' checked="checked"'; ?> tabindex="3" /><?php echo $lang_login['Remember me'] ?><br /></label>
						</div>
