...
if (($cur_forum['post_topics'] == '' && $pun_user['g_post_topics'] == '1') || $cur_forum['post_topics'] == '1' || $is_admmod)
	$post_link = "\t\t\t".'<p class="postlink conr"><form method="post" action="post.php?fid='.$id.'"><button class="mui-btn mui-btn--primary mui-btn--raised" formaction="post.php?fid='.$id.'">'.$lang_forum['Post topic'].'</button></p>'."\n";
else
	$post_link = '';
...
<div class="linkst">
	<div class="inbox crumbsplus">
		...
		<div class="nav-wrapper">
			...
			<li><span>»&#160;</span><strong><a href="viewforum.php?id=<?php echo $id ?>" class="breadcrumb"><?php echo pun_htmlspecialchars($cur_forum['forum_name']) ?></a></strong></p></li>
			</div>
			<div class="floaty" align="right"><?php echo $post_link ?></div>
		</div>
		</ul>
...
?>
		...
		<p class="pagepost">
			<p class="pagelink conl pagelink"><?php echo $paging_links ?></p>
			<div class="floaty" align="right"><?php echo $post_link ?></div>
		</p>
<?php
